...
values(1, 1, 'Alice', 'Johnson', '5000 South Broad St', 'Philadelphia', 'PA', '19112', true, 'alice.johnson@urbanoutfitters.com', '215-555-1234'),
...
values(1, 'Dianne', "Connor's", 75000.00, '2022-01-15', 'Software Engineer', 'Dianne@microsoft.com', '425-555-1234'),
...
values(1, 1, 1, '2023-01-10', 'Initial meeting with Alice from Urban Outfitters to discuss collaboration opportunities.'),
...
delete from Contact_Employee 
  where employee_id = (select employee_id from employee where firstname = "Dianne" and lastname = "Connor's" ) and 
employee_id = (select employee_id from employee where firstname = 'Jack' and lastname = 'Lee');

select e.first_name,e.last_name from contact e join company c on e.company_id = c.company_id where company_name = 'Microsoft';
